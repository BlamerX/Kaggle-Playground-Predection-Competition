...
# Import all modules
import config
from data_loader import load_datasets, get_data_summary
...
def run_complete_pipeline(skip_eda=False, scaling_method=None, target_metric='mse', 
    ...
    try:
        ...
        print(f"[OK] Data exploration completed")
        ...
        print(f"[OK] Data preprocessing completed")
