...
class CFG:
    VERSION = "V20"
    DESCRIPTION = "CatBoost_Focal_Loss"
    
    # CatBoost Adaptation of Deotte Params with Focal Loss
    # Focal Loss Params: Alpha=0.25 (Common for imbalance), Gamma=2.0 (Standard)
    # Note: CatBoost implementation might default to specific params or require string
    CAT_PARAMS = {
        'iterations': 50000,
        'learning_rate': 0.01,
        'depth': 3,
        ...
        'task_type': 'CPU', # GPU does NOT support Focal Loss
        # 'bootstrap_type': 'Bernoulli', # Not needed for CPU without GPU constraints
        'allow_writing_files': False
    }
    
    SEED = 42
    N_FOLDS = 5 # Reduced from 15 as requested
    INNER_FOLDS = 5 # Reduced Inner Folds too for speed
...
def main():
    ...
    print(f"================================================================================")
    print(f"Goal: Improve V17 (Champion) by using Focal Loss to target hard examples.")
    print(f"================================================================================")
    ...
    for i, (train_index, val_index) in enumerate(kf.split(train)):
        ...
        # Final Prep
        # Deotte Strategy: DROP CATS. Rely on TE.
        ...
        # Note: CatBoost Focal Loss auto-handles the objective derivative
