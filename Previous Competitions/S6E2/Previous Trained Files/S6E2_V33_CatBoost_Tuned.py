...
class CFG:
    VERSION = "V33"
    DESCRIPTION = "CatBoost_Tuned_Deotte"
    
    # Tuning based on V17 (0.95385)
    # Goal: Squeeze more out of Stumps by adding Randomness/Regularization
    CAT_PARAMS = {
        'iterations': 50000,
        'learning_rate': 0.0025,
        'depth': 3,                 # Keep Stumps
        'l2_leaf_reg': 5,           # Added: Regularization
        'random_strength': 2,       # Added: Randomness to decision boundaries
        'bagging_temperature': 1,   # Added: Bayesian Bootstrap
        'random_seed': 42,
        'early_stopping_rounds': 1000,
        'eval_metric': 'AUC',
        'task_type': 'GPU', 
        'bootstrap_type': 'Bayesian', # Change from Bernoulli to Bayesian
        'allow_writing_files': False
    }
    
    SEED = 42
    N_FOLDS = 15 # Reverted to 15 to match V17 exactly
    INNER_FOLDS = 15
