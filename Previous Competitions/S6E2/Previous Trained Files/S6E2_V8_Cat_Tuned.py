"""
S6E2 V8 - Tuned CatBoost (FLAML Optimized)
==========================================
Strategy:
1. RAW Features (13 cols).
2. FLAML Optimized Hyperparameters (Best CV: 0.95508).
"""
...
class CFG:
    ...
    PARAMS = {
        "n_estimators": 8192,
        "learning_rate": 0.15330585166091915,
        "early_stopping_rounds": 10,
        "loss_function": "Logloss",
        "eval_metric": "AUC",
        "task_type": "GPU", # Will fallback
        "random_seed": 42,
        "verbose": 500,
...
print("="*80)
print(f"{CFG.EXP_ID} - CatBoost Tuned")
print("="*80)
...
with open("Best_Params/tuned_v8_cat.json", "w") as f:
    json.dump(CFG.PARAMS, f, indent=4)

print(f"\nSaved Tuned V8. Mean CV: {mean_score:.5f}")
print("Saved Params to Best_Params/tuned_v8_cat.json")
