"""
S6E1 V46 - LightGBM WITHOUT Golden Features
============================================
Based on V36/Stage3 LightGBM but using V32 features ONLY (NO Golden Features).
Expected: Better LB generalization than V36 (8.58278)
"""
...
print("="*80)
print("S6E1 V46 - LightGBM (NO Golden Features)")
print("="*80)
...
# ============================================================================
# 3. FEATURE ENGINEERING (V32 ONLY - NO GOLDEN!)
# ============================================================================
...
def preprocess_v32(df, cmt_cols):
    """Generate V32 features ONLY - NO Golden Features!"""
    df_temp = df.copy()
    eps = 1e-5

    # --- V32 FEATURES ONLY (NO GOLDEN!) ---
    ...
    # Feature list - NO GOLDEN FEATURES!
    numeric_features = [
...
print(f"Features created: {X.shape[1]} (NO Golden Features)")
...
# Same params as V36, CPU optimized
lgb_params = {
...
print(f"\n{'='*80}")
print(f"V46 LGB (No Golden) OOF RMSE: {final_rmse:.5f}")
print(f"V36 LGB (With Golden) OOF RMSE: 8.62340")
print(f"Improvement: {8.62340 - final_rmse:+.5f}")
print("="*80)

submission = pd.read_csv(test_file, usecols=['id'])
submission['exam_score'] = test_total
submission.to_csv("submission_v46_lgb.csv", index=False)

oof_df = pd.DataFrame({'id': train_df['id'], 'oof_pred': oof_total})
oof_df.to_csv("oof_v46_lgb.csv", index=False)

print("Saved: submission_v46_lgb.csv, oof_v46_lgb.csv")
