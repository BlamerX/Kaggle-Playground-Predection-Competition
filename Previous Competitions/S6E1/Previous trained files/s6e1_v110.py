"""
S6E1 V110 - CatBoost DART + 5-Seed (Combining V108 + V109)
============================================================
V108: DART params → 8.54736 LB (best)
V109: 5-seed averaging → 8.54743 LB (best OOF 8.55997)

V110: DART + 5-seed = Best of both worlds
"""
...
print("="*80)
print("S6E1 V110 - CatBoost DART + 5-Seed")
print("="*80)
...
print(f"\n{'='*80}")
print("V110: CATBOOST DART + 5-SEED")
print("="*80)
...
for seed_idx, SEED in enumerate(SEEDS, start=1):
    ...
    catboost_dart_params['random_seed'] = SEED
...
# Average all seeds
final_oof_v110 = np.mean(all_seed_oof, axis=0)
final_test_v110 = np.mean(all_seed_test, axis=0)
v110_rmse = np.sqrt(mean_squared_error(y, final_oof_v110))
...
|---------|-------|----------|----------|
| V108 | DART (1 seed) | 8.55998 | 8.54736 |
| V109 | Default (5 seeds) | 8.55997 | 8.54743 |
| **V110** | **DART (5 seeds)** | **{v110_rmse:.5f}** | **?** |
""")
...
pd.DataFrame({'id': test_df['id'], 'exam_score': final_test_v110}).to_csv("submission_v110.csv", index=False)
pd.DataFrame({'id': train_df['id'], 'exam_score': final_oof_v110}).to_csv("oof_v110.csv", index=False)

elapsed = (time.time() - start_time) / 60
print(f"\nFiles saved: submission_v110.csv, oof_v110.csv")
