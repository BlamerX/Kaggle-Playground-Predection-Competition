"""
S6E1 V67 - LightGBM + Boosted Pseudo-Labels (CPU)
==================================================
Based on V46 LightGBM + HW-27 Boosted PL logic
Target: ~8.57-8.58 LB

Strategy:
1. Train V46 LightGBM baseline → get test pseudo-labels
2. Train residual LightGBM on errors
3. Update pseudo-labels: new = old + α × residual_pred
4. Retrain with pseudo-labels
5. Repeat N times

CPU-optimized for local runs.
"""
...
print("="*80)
print("S6E1 V67 - LightGBM + Boosted Pseudo-Labels (CPU)")
print("="*80)
...
# =============================================================================
# 6. BOOSTED PSEUDO-LABELS (5 iterations)
# =============================================================================
...
oof_df.to_csv("oof_v67.csv", index=False)

elapsed = (time.time() - start_time) / 60
print(f"\nFiles saved:")
print(f"  submission_v67.csv")
print(f"  oof_v67.csv (for ensemble use)")
...
print(f"|---------|----------|-------------|")
print(f"| V46 (baseline) | 8.62xxx | 8.64784 |")
print(f"| **V67** | **{best['oof_rmse']:.5f}** | **~8.57-8.58** |")
print("\n✅ V67 ready for submission!")
print("="*80)
