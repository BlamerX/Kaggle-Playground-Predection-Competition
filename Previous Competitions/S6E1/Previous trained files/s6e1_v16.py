"""
S6E1 V16 - V13 + seed_42
=========================
Based on V16 ablation experiments:
- seed_42 gives best OOF improvement (-0.00140) over V13
- All other changes were neutral or hurt

Expected: OOF 8.60777 (vs V13's 8.60917)
"""
...
# ============================================================================
# Feature Engineering (V13 exact - 45 features)
# ============================================================================
...
# ============================================================================
print("\n--- Feature Engineering ---")
X_raw, numeric_cols = preprocess_v13(train_df)
X_test_raw, _ = preprocess_v13(test_df)
X_orig_raw, _ = preprocess_v13(original_df)
...
print(f"Features: {X.shape[1]} (45 - same as V13)")
...
FOLDS = 10
# KEY CHANGE: seed_42 instead of seed_1003
...
oof_df.to_csv("oof_v16.csv", index=False)

# Submission
submission_df[TARGET] = np.mean(test_preds_xgb, axis=0)
submission_df.to_csv("submission_v16.csv", index=False)

print(f"  oof_v16.csv")
print(f"  submission_v16.csv")
...
print("=" * 80)
print("\nKey change: random_state=42 (V13 used 1003)")
