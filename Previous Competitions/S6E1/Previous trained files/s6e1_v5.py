...
# ============================================================================
# S6E1 V5 - FAST ENCODING + ALL FEATURES (Best of Both)
# Combines V4's fast encoding with V3's full feature set (no selection)
# ============================================================================
...
print("="*70)
print("S6E1 V5 - Fast Encoding + All 147 Features")
print("="*70)
...
print(f"\nFinal Feature Count: {X_train.shape[1]} (ALL features kept)")
