"""
S6E3 V36 - V16 Features + Hidden Features
================================================================================
Strategy: V16 (Full Digit Features + N-gram TE) + Hidden Features

Hidden Features (based on correlation analysis):
  - fiber_m2m: +0.5413 (55% vs 6.8% churn) - THE KILLER FEATURE
  - combined_risk: +0.5460 
  - risk_score: +0.5993
  - is_brand_new: +0.2637
...
class CFG:
    VERSION_NAME = "V36"
    EXP_ID = "S6E3_V36_V16_HiddenFeatures"
...
if __name__ == "__main__":
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    # [2/6] Feature Engineering — Core (V7 -> V14 baseline)
    # ═══════════════════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    # [3/6] Digit Features from Numericals 
    # ═══════════════════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    # [4/6] Hidden Features (THE KEY IMPROVEMENT)
    # ═══════════════════════════════════════════════════════════════════════════
    print("\n[4/6] Creating Hidden Features...")
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    # [5/6] Bi-gram / Tri-gram Composite Categoricals (V14 Baseline)
    # ═══════════════════════════════════════════════════════════════════════════
    print("\n[5/6] Creating N-gram Categorical Features...")
    ...
    print(f"    - Engineered: {len(NEW_NUMS)} (including {len(DIGIT_FEATURES)} digit + {len(HIDDEN_FEATURES)} hidden)")
    print(f"    - N-grams: {len(NGRAM_COLS)}")
    
    # ═══════════════════════════════════════════════════════════════════════════
    # [6/6] Training (10-Fold CV)
    # ═══════════════════════════════════════════════════════════════════════════
    print(f"\n[6/6] Training XGBoost ({CFG.N_FOLDS}-Fold CV)...")
    ...
    for i, (train_idx, val_idx) in enumerate(skf_outer.split(train, train[CFG.TARGET])):
        ...
        if i == 0:
            ...
            for rank, (fname, fval) in enumerate(imp.sort_values(ascending=False).head(15).items()):
    ...
    print(f"\n{'='*80}")
    print(f"V36 RESULTS — V16 Features + Hidden Features")
    print(f"{'='*80}")
