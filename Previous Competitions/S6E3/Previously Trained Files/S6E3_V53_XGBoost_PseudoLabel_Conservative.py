"""
S6E3 V53 - XGBoost + Pseudo-Labeling (Conservative)
================================================================================
Strategy: V16b Reference + Conservative Pseudo-Labeling

Key Idea:
  Use V16b's test predictions as pseudo-labels for training.
...
class CFG:
    VERSION_NAME = "v53"
    EXP_ID = "S6E3_V53_XGBoost_PseudoLabel_Conservative"
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*80}")
    print(f"V53 RESULTS — XGBoost + Pseudo-Labeling (Conservative)")
    print(f"{'='*80}")
